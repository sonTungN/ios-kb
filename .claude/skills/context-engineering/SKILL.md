...
> NOTE (this repo): the auto-injection below depends on claudekit hooks that are **not installed here** — treat it as reference for how such a system works, not an active feature. The thresholds and four-bucket strategy still apply when reasoning about context manually.
