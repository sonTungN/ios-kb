...
Defined by `.claude/data-storage/`, which is the authority on all of it.
...
| **Chapter** | One of the run's three eras — *Giữ lửa* (cards 1–12) · *Giữ nếp* (13–22) · *Hồi sinh* (23–36). A chapter is a stage inside one continuous run, not a separate level; stats carry across unchanged. |
...
| **Ledger / Sổ gia truyền** | The in-game screen listing preparations held, open and missed. When it unlocks is the main thing difficulty changes. |
